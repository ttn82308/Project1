...
--
-- Host: localhost
-- Generation Time: Dec 24, 2024 at 10:24 AM
...
(1, 3, '2024-12-31', 'Chảy máu vùng đầu do va đập', 17, 605000, 0),
(2, 6, '2025-01-01', 'Tiểu buốt, tiểu rắt, đau bụng dưới', 16, 1230000, 0);
...
(5, 2, 15, 10, 'Uống sau khi ăn', 'Viên'),
(6, 2, 60, 2, 'Thoa', 'Chai'),
(7, 2, 74, 5, 'Uống sau khi ăn', 'Viên');
...
(15, 'Azithromycin', 'Uống sau khi ăn', 'Viên', 550000.00),
