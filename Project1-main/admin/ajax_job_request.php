    ...
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        <tr>
            ...
            <td>
                <div class='row'>
                    <div class='col-md-6'>
                        <button data-id='".htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8')."' class='btn btn-success approve'>Xác nhận</button>
                    </div>
                    <div class='col-md-6'>
                        <button data-id='".htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8')."' class='btn btn-danger reject'>Từ chối</button>
                    </div>
                </div>
            </td>
        </tr>
